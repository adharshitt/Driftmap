...
macro_rules! export_plugin {
    ($ty:ty) => {
        ...
        pub extern "C" fn score_pair(
            req_a_method: *const u8,
            req_a_method_len: usize,
            req_a_path: *const u8,
            req_a_path_len: usize,
            req_a_body: *const u8,
            req_a_body_len: usize,
            res_a_status: u16,
            res_a_body: *const u8,
            res_a_body_len: usize,
            req_b_method: *const u8,
            req_b_method_len: usize,
            req_b_path: *const u8,
            req_b_path_len: usize,
            req_b_body: *const u8,
            req_b_body_len: usize,
            res_b_status: u16,
            res_b_body: *const u8,
            res_b_body_len: usize,
        ) -> f32 {
            let req_a = $crate::Request {
                method: req_a_method,
                method_len: req_a_method_len,
                path: req_a_path,
                path_len: req_a_path_len,
                body: req_a_body,
                body_len: req_a_body_len,
            };
            let res_a = $crate::Response {
                status: res_a_status,
                body: res_a_body,
                body_len: res_a_body_len,
            };
            let req_b = $crate::Request {
                method: req_b_method,
                method_len: req_b_method_len,
                path: req_b_path,
                path_len: req_b_path_len,
                body: req_b_body,
                body_len: req_b_body_len,
            };
            let res_b = $crate::Response {
                status: res_b_status,
                body: res_b_body,
                body_len: res_b_body_len,
            };
